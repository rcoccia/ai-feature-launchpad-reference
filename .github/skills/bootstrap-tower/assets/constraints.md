...
Questi cinque vincoli sono leggi del metodo installato, non vincoli di prodotto. Mantieni gli ID e
i blocchi completi: i riferimenti puntano a superfici locali copiate dal kit. I primi quattro sono
la baseline universale di ogni Change Record; `FUN-ARCHREVIEW-01` è sempre disponibile ma si attiva
come proof obligation solo quando una slice introduce una decisione load-bearing.
